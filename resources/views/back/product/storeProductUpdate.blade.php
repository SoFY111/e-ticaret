                ...
                <div class="form-group d-flex flex-row justify-content-between align-items-center ">
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="checkbox" name="isPc" id="isPc" class="form-check-input" @if($productUpdate->isPc) checked @endif value="isPc">Bilgisayar
                        </label>
                    </div>
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="checkbox" name="isPs" id="isPs" class="form-check-input" @if($productUpdate->isPs) checked @endif value="isPs">PlayStation
                        </label>
                    </div>
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="checkbox" name="isXbox" id="isXbox" class="form-check-input" @if($productUpdate->isXbox) checked @endif value="isXbox">XBOX
                        </label>
                    </div>
                </div>
            </div>
