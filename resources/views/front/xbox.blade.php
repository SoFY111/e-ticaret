...
@section('title') Xbox @endsection
@section('content')

<div class="page-head_agile_info_w3l">
    <div class="container">
        <h3>Xbox<span></span></h3>
        <!--/w3_short-->
            ...
            <div class="col-md-8 products-right">
                ...
                <div class="men-wear-bottom">
                    ...
                    <div class="col-sm-8 men-wear-right">
                        ...
                        <p style="text-align: justify">Xbox Oyunları fiyatlarını ve özelliklerini en popüler, en ucuz, en yeni ürünler olarak gruplayabilirsiniz. Xbox Oyunları fiyatları karşılaştırma listesine ekleyerek size en uygun seçenekleri tek ekranda inceleyin. Xbox Oyunları kategorisinde en favori markalar şu şekilde: Lego, Microsoft. </p>
                    </div>
                    <div class="clearfix"></div>
                </div>
            <div class="clearfix"></div>
