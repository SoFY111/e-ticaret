	...
	<div class="container">
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					...
					<div class="description">
						...
						<input type="text" value="Kodu Girin" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Kodu Girin';}" required="">
						   ...
						   <div class="tab3">
							...
							<div class="single_page_agile_its_w3ls">
							  <h6>{{$product['descriptionHead']}}</h6><br>
							   ...
							   <p class="w3ls_para"><span style="font-weight:   700">RAM </span>: 256 MB</p>
							   <p class="w3ls_para"><span style="font-weight:   700">Boş Alan </span>: 4 GB</p>
							</div>
						</div>
                        <div class="tab2">
								...
								<div class="bootstrap-tab-text-grids">
									<div class="bootstrap-tab-text-grid">
										<div class="bootstrap-tab-text-grid-left">
											<img src="{{asset('front/images/template-images')}}/t1.jpg" alt=" " class="img-responsive">
										</div>
										<div class="bootstrap-tab-text-grid-right">
											<ul>
												<li><a href="#">Admin</a></li>
												<li><a href="#"><i class="fa fa-reply-all" aria-hidden="true"></i> Cevapla</a></li>
											</ul>
									 ...
									 <div class="add-review">
										<h4>İnceleme Ekle</h4>
										<form action="#" method="post">
												<input type="text" name="Name" placeholder="Ad Soyad" required="Name">
